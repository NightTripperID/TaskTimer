...
class CursorRecyclerViewAdapter extends RecyclerView.Adapter<CursorRecyclerViewAdapter.TaskViewHolder> {
    ...
    CursorRecyclerViewAdapter(Cursor mCursor, OnTaskClickListener listener) {
...
//        Log.d(TAG, "getItemCount: starts");
     ...
     * The returned old Curor is <em>not</em> closed.
     * @param newCursor The new cursor to be used
     * @return Returns the previously set Curosr, or null if there wasn't one
